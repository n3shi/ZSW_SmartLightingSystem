...
export default new Vuex.Store({
  ...
  mutations: {
    setCurrentOptions(state, payload) {state.mainManager.manager.push(payload);},
    setRoomName(state, payload) {state.activeRoom.name = payload;},
	...
	setChoosenBlock(state, payload) {state.choosenBlock = payload;},
	setLightSourceIndex(state, payload) { state.lightSourceIndex = payload;},
	setAllRooms(state, payload) { state.mainManager.manager = payload;},
	setMainManager(state, payload) { state.mainManager = payload;},
  ...
  getters: {
	...
	getRoom: (state) => (name) => state.mainManager.manager.find((el) => el.name === name),
